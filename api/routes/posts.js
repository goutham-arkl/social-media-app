...
const { createPost, updatePost, deletePost, likeAndUnlike, getAPost, timeline, addComment, unComment, userPosts, getAllComments, allPosts, reportPost, allReports, rejectReport, resolveReport } = require("../controllers/postController");
